...
class GetProfEditDetailsAPIView(APIView):
    ...
    def get(self, request, profile_id, *args, **kwargs):
        ...
        response_data['profile_common_details']={
                ...
                "membership_fromdate": format(profile_plan_features.membership_fromdate, 'Y-m-d') if profile_plan_features.membership_fromdate else '0000-0-0',
                "membership_todate": format(profile_plan_features.membership_todate, 'Y-m-d') if profile_plan_features.membership_todate else '0000-0-0',
